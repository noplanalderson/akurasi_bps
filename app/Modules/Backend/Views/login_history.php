            ...
            <div class="col-lg-12 col-md-12">
                <div class="card mb-4 border-custom mx-auto">
                    <div class="card-header">
                        <h6 class="float-left">Login History</h6>
                    </div>
                    <div class="card-body h-100">
                        ...
                        <div class="table-responsive">
                            ...
                            <table id="tbl_login_history" class="table table-striped table-bordered table-sm ft-align-items-center">
                                <thead>
                                    <tr class="text-center">
                                        <th>Waktu</th>
                                        <th class="no-sort">Alamat IP</th>
                                        <th class="no-sort">Peramban</th>
                                        <th class="no-sort">Perangkat</th>
                                    </tr>
                                </thead>
                                <tbody>
                                </tbody>
